(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.paypalBusinessEmail = "ourproject@gmail.com"; // Your Business PayPal's account email address
			...
			if( this.$formCart.length ) {
				...
				if( items.length == 0 ) {
					...
					for( var i = 0; i < items.length; ++i ) {
						...
						var qty = item.qty;
						var html = "<tr><td class='pname' name='product'>" + product + "</td>" + "<td class='pqty'><input type='text' name='qt' value='" + qty + "' class='qty'/></td>";
					    	html += "<td class='pprice' name='price'>" + price + "</td><td class='pdelete' name='pt'><a href='' data-product='" + product + "'>&times;</a></td></tr>";
